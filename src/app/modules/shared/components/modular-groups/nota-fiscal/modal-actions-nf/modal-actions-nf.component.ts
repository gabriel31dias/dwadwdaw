...
@Component({
  selector: 'app-modal-actions-nf',
  templateUrl: './modal-actions-nf.component.html',
  styleUrls: ['./modal-actions-nf.component.scss']
})
export class ModalActionsNfComponent implements OnInit {
